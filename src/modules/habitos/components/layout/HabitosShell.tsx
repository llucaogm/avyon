...
const nav: SlidingBottomNavItem[] = [
  { to: '/habitos', label: 'Hoje', icon: CheckSquare, end: true },
  { to: '/habitos/habits', label: 'Gerenciar', icon: ListChecks },
]
