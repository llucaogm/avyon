...
export default function FixedExpensesPage() {
  return (
    <div className="flex flex-col gap-4">
      <div>
        <h1 className="font-display text-2xl font-semibold">Gastos Fixos</h1>
        <p className="text-sm text-muted-foreground">
          Contas e recebimentos recorrentes, com valor mensal planejado. Lançamentos e relatórios de todo o app
          atualizam sozinhos.
        </p>
      </div>
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {!isLoading && categories.length === 0 && (
        <EmptyState message="Nenhum gasto fixo ainda. Adicione o primeiro." />
      )}
                    ...
                    <Button
                      ...
                      onClick={() =>
                        deleteCategory.mutate(c.id, {
                          onError: () => toast.error('Não consegui excluir esse gasto fixo'),
                        })
                      }
                    >
