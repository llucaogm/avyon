...
import { LayoutDashboard, Receipt, PiggyBank, Target, TrendingUp, Shield, Tags, BookOpen } from 'lucide-react'
...
const secondaryNav: SlidingBottomNavItem[] = [
  ...
  { to: '/financeiro/settings/categories', label: 'Categorias', icon: Tags },
